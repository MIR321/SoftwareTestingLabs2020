...
public class DifferentElementsPage extends BasePage {
    ...
    public DifferentElementsPage chooseCertainComboBoxElement(int index, boolean haveToVerifyLog){
        if(index < 0 || index > 3)
    ...
    public DifferentElementsPage clickOnCertainCheckBox(int index, boolean haveToVerifyLog){
        if(index < 0 || index > 3)
            throw new IllegalArgumentException();
    ...
    public DifferentElementsPage clickOnCertainRadioButton(int index, boolean haveToVerifyLog){
        if(index < 0 || index > 3)
            throw new IllegalArgumentException();
    ...
    public DifferentElementsPage defaultButtonClick(boolean haveToVerifyLog){
    ...
    public DifferentElementsPage buttonButtonClick(boolean haveToVerifyLog){
